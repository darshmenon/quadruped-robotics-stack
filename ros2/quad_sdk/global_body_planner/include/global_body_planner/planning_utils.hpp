...
struct PlannerConfig {
   ...
   */
  void loadParamsFromServer(rclcpp::Node::SharedPtr node) {
    // Load robot parameters
    quad_utils::loadROSParam(node, "global_body_planner.h_max", h_max);
    quad_utils::loadROSParam(node, "global_body_planner.h_min", h_min);
    quad_utils::loadROSParam(node, "global_body_planner.h_nom", h_nom);
    quad_utils::loadROSParam(node, "global_body_planner.v_max", v_max);
    quad_utils::loadROSParam(node, "global_body_planner.v_nom", v_nom);
    quad_utils::loadROSParam(node, "global_body_planner.robot_l", robot_l);
    quad_utils::loadROSParam(node, "global_body_planner.robot_w", robot_w);
    quad_utils::loadROSParam(node, "global_body_planner.robot_h", robot_h);

    quad_utils::loadROSParam(node, "global_body_planner.mass", mass);
    ...
    quad_utils::loadROSParam(node, "global_body_planner.g", g);
    quad_utils::loadROSParam(node, "global_body_planner.mu", mu);
    quad_utils::loadROSParam(node, "global_body_planner.t_s_min", t_s_min);
    quad_utils::loadROSParam(node, "global_body_planner.t_s_max", t_s_max);
    quad_utils::loadROSParam(node, "global_body_planner.dz0_min", dz0_min);
    quad_utils::loadROSParam(node, "global_body_planner.dz0_max", dz0_max);
    quad_utils::loadROSParam(node, "global_body_planner.dt", dt);
    quad_utils::loadROSParam(node, "global_body_planner.backup_ratio",
                             backup_ratio);
    quad_utils::loadROSParam(node, "global_body_planner.trapped_buffer_factor",
                             trapped_buffer_factor);
    quad_utils::loadROSParam(node, "global_body_planner.num_leap_samples",
                             num_leap_samples);
    quad_utils::loadROSParam(node, "global_body_planner.max_planning_time",
                             max_planning_time);
